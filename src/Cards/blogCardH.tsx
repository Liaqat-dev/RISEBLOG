...
//                     <h3 className="text-[11px] w-[83%] font-semibold text-[#1C1C1C] ">
...
//                         <p className={'text-secondary text-[10px] text-white px-1 bg-gradient-primary rounded-full'}>{author}</p>
    ...
    return (
        ...
        >
            ...
            <section className="p-[5px] w-full flex flex-col justify-between">
                ...
                <div className="w-full flex justify-between items-center">
                    <p className='text-secondary text-[10px] md:text-[11px] lg:text-[12px] xl:text-[13px] text-white px-1 bg-gradient-primary rounded-full'>
                        {author}
                    </p>
                    <div className='flex justify-between items-center gap-1'>
                        {liked ? (
